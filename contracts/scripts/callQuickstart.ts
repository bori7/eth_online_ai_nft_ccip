...
async function main() {
    ...
    console.log(`Image generation ended with transactionResponse: "${JSON.stringify(transactionResponse)}"`);
    console.log(`Image generation ended with receipt: "${JSON.stringify(receipt)}"`);
